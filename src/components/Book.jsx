  ...
  return (
    <div >
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          <h4 className="text-lg font-bold lg:text-xl">{bookDetails.bookName}</h4>
          <p className="text-xs lg:text-sm">
            By : <span>{bookDetails.writer}</span>
          </p>
          <div className="flex items-center justify-between">
            <h4 className="text-lg font-bold lg:text-xl">${bookDetails.price}</h4>
